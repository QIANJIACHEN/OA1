<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:56:"themes/admin_simpleboot3/portal\admin_article\index.html";i:1516676889;s:75:"D:\tools\upupw\htdocs\oa\public\themes\admin_simpleboot3\public\header.html";i:1516676889;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
    ...
    $(function () {
        ...
        Wind.use('ajaxForm', 'artDialog', 'iframeTools', function () {
            ...
            $('.js-articles-copy').click(function (e) {
                ...
                ids = ids.join(',');
                art.dialog.open("/oa/public/index.php?g=portal&m=AdminArticle&a=copy&ids=" + ids, {
                    title: "批量复制",
                    width: "300px"
                });
            });
            ...
            $('.js-articles-move').click(function (e) {
                ...
                ids = ids.join(',');
                art.dialog.open("/oa/public/index.php?g=portal&m=AdminArticle&a=move&old_term_id=<?php echo (isset($term['term_id']) && ($term['term_id'] !== '')?$term['term_id']:0); ?>&ids=" + ids, {
                    title: "批量移动",
                    width: "300px"
                });
            });
