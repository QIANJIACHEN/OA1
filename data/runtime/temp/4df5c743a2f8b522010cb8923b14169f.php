<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:37:"themes/simpleboot3/portal\\index.html";i:1516676889;s:67:"D:\tools\upupw\htdocs\oa\public\themes\simpleboot3\public\head.html";i:1516676889;s:71:"D:\tools\upupw\htdocs\oa\public\themes\simpleboot3\public\function.html";i:1516676889;s:66:"D:\tools\upupw\htdocs\oa\public\themes\simpleboot3\public\nav.html";i:1516676889;s:69:"D:\tools\upupw\htdocs\oa\public\themes\simpleboot3\public\footer.html";i:1516676889;s:70:"D:\tools\upupw\htdocs\oa\public\themes\simpleboot3\public\scripts.html";i:1516676889;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<![endif]-->
<link rel="icon" href="/oa/public/themes/simpleboot3/public/assets/images/favicon.png" type="image/png">
<link rel="shortcut icon" href="/oa/public/themes/simpleboot3/public/assets/images/favicon.png" type="image/png">
<link href="/oa/public/themes/simpleboot3/public/assets/simpleboot3/themes/simpleboot3/bootstrap.min.css" rel="stylesheet">
<link href="/oa/public/themes/simpleboot3/public/assets/simpleboot3/font-awesome/4.4.0/css/font-awesome.min.css" rel="stylesheet"
      type="text/css">
<!--[if IE 7]>
<link rel="stylesheet" href="/oa/public/themes/simpleboot3/public/assets/simpleboot3/font-awesome/4.4.0/css/font-awesome-ie7.min.css">
<![endif]-->
<link href="/oa/public/themes/simpleboot3/public/assets/css/style.css" rel="stylesheet">
<style>
...
<script src="/oa/public/themes/simpleboot3/public/assets/js/jquery-1.10.2.min.js"></script>
<script src="/oa/public/themes/simpleboot3/public/assets/js/jquery-migrate-1.2.1.js"></script>
<script src="/oa/public/static/js/wind.js"></script>
	
    <link href="/oa/public/themes/simpleboot3/public/assets/css/slippry/slippry.css" rel="stylesheet">
    <style>
        .caption-wraper {
            position: absolute;
            left: 50%;
    ...
    <?php 
    \think\Hook::listen('before_head_end',$temp5a66ee8ed498e,null,false);
 ?>
</head>
...
<nav class="navbar navbar-default navbar-fixed-top active">
    <div class="container active">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="/oa/public/"><?php echo (isset($theme_vars['company_name']) && ($theme_vars['company_name'] !== '')?$theme_vars['company_name']:'ThinkCMF'); ?></a>
        </div>
...
function __parse_navigationec40242582388c41a97261d9ec647cf4($menus,$level=1){
$_parse_navigation_func_name = '__parse_navigationec40242582388c41a97261d9ec647cf4';
...
if(''==''): ?>
    <?php echo __parse_navigationec40242582388c41a97261d9ec647cf4($menus); else: ?>
    < id="main-navigation" class="nav navbar-nav navbar-nav-custom">
        <?php echo __parse_navigationec40242582388c41a97261d9ec647cf4($menus); ?>
    </>
<?php endif; ?>
                ...
                <li class="dropdown user login">
                    <a class="dropdown-toggle user" data-toggle="dropdown" href="#">
                        <?php $user=cmf_get_current_user(); if(empty($user['avatar'])): ?>
                            <img src="/oa/public/themes/simpleboot3/public/assets/images/headicon.png" class="headicon">
                            <?php else: ?>
...
if(count($__SLIDE_ITEMS__) == 0): ?>
        ...
        <li>
            ...
            <a href=""><img src="/oa/public/themes/simpleboot3/public/assets/images/demo/1.jpg" alt=""></a>
        </li>
        <li>
            <div class="caption-wraper">
                <div class="caption">此幻灯片只是演示,您没有设置任何幻灯片,请到后台模板设置！</div>
            </div>
            <a href=""><img src="/oa/public/themes/simpleboot3/public/assets/images/demo/2.jpg" alt=""></a>
        </li>
        <li>
            <div class="caption-wraper">
                <div class="caption">此幻灯片只是演示,您没有设置任何幻灯片,请到后台模板设置！</div>
            </div>
            <a href=""><img src="/oa/public/themes/simpleboot3/public/assets/images/demo/3.jpg" alt=""></a>
        </li>
...
<div class="container">
 ...
 ?>
        ...
        <?php 
         ...
         $__FOR_START_513__=1;$__FOR_END_513__=$rows;for($row=$__FOR_START_513__;$row <= $__FOR_END_513__;$row+=1){ 
                $first_row = ($row-1)*3;
                            ...
                            <div class="item-image">
                                <a href="<?php echo cmf_url('portal/Article/index',array('id'=>$vo['id'],'cid'=>$vo['category_id'])); ?>">
                                    <?php if(isset($vo['more']['thumbnail'])): if(empty($vo['more']['thumbnail']) || (($vo['more']['thumbnail'] instanceof \think\Collection || $vo['more']['thumbnail'] instanceof \think\Paginator ) && $vo['more']['thumbnail']->isEmpty())): ?>
                                            <img src="/oa/public/themes/simpleboot3/public/assets/images/default-thumbnail.png"
...
<div id="footer">
    <?php 
    \think\Hook::listen('footer_start',$temp5a66ee8ed4a76,null,false);
 ?>
    <div class="links">
        <?php
...
<!-- Le javascript
    ...
    <script src="/oa/public/themes/simpleboot3/public/assets/simpleboot3/bootstrap/js/bootstrap.min.js"></script>
    <script src="/oa/public/static/js/frontend.js"></script>
	<script>
	$(function(){
...
<script src="/oa/public/themes/simpleboot3/public/assets/js/slippry.min.js"></script>
<script>
    $(function () {
        $("#home-slider").slippry({
            transition: 'fade',
...
<?php 
    \think\Hook::listen('before_body_end',$temp5a66ee8ed4ade,null,false);
 ?>
</body>
</html>
