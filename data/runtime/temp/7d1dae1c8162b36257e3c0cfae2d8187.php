...
<head>
    ...
    <![endif]-->
    <link href="/oa/public/themes/admin_simpleboot3/public/assets/themes/<?php echo cmf_get_admin_style(); ?>/bootstrap.min.css" rel="stylesheet">
    <link href="/oa/public/themes/admin_simpleboot3/public/assets/simpleboot3/css/simplebootadmin.css" rel="stylesheet">
    <link href="/oa/public/static/font-awesome/css/font-awesome.min.css?page=index" rel="stylesheet" type="text/css">
    <link rel="stylesheet" href="/oa/public/themes/admin_simpleboot3/public/assets/themes/<?php echo cmf_get_admin_style(); ?>/simplebootadminindex.min.css">
    <!--[if lt IE 9]>
        ...
        <div class="navbar-collapse collapse" id="navbar-main">
            ...
            <ul class="nav navbar-nav navbar-right simplewind-nav">
                <li class="light-blue" style="border-left:none;display: none;" id="close-all-tabs-btn">
                    <a id="close-wrapper" href="javacript:void(0);" title="<?php echo lang('CLOSE_TOP_MENU'); ?>" style="color:#fff;font-size: 16px">
                ...
                <li class="light-blue dropdown" style="border-left:none;">
                    <a data-toggle="dropdown" href="#" class="dropdown-toggle">
                        <?php if(isset($admin['avatar']) && $admin['avatar']): ?>
                            ...
                            <?php else: ?>
                            <img class="nav-user-photo" width="30" height="30"
                                 src="/oa/public/themes/admin_simpleboot3/public/assets/images/logo-18.png" alt="<?php echo (isset($admin['user_login']) && ($admin['user_login'] !== '')?$admin['user_login']:''); ?>">
                        <?php endif; ?>
...
<div class="main-container container-fluid">
    ...
    <div class="sidebar" id="sidebar">
        <div class="sidebar-shortcuts" id="sidebar-shortcuts">
            <a class="btn btn-sm btn-warning" href="/oa/public/"
...
<script src="/oa/public/themes/admin_simpleboot3/public/assets/js/jquery-1.10.2.min.js"></script>
<script src="/oa/public/static/js/wind.js"></script>
<script src="/oa/public/themes/admin_simpleboot3/public/assets/js/bootstrap.min.js"></script>
<script src="/oa/public/static/js/admin.js"></script>
<script src="/oa/public/themes/admin_simpleboot3/public/assets/simpleboot3/js/adminindex.js"></script>
<script>
    $(function () {
